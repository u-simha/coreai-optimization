...
| Preset                                                                            | Description                                                                    |
|-----------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [w4()](coreai_opt.quantization.QuantizerConfig.presets.w4.md)                     | int4 weight-only quantization, per-channel symmetric.                          |
| [w4_per_block()](coreai_opt.quantization.QuantizerConfig.presets.w4_per_block.md) | int4 weight-only quantization, per-block symmetric, block_size defaults to 32. |
| [w8()](coreai_opt.quantization.QuantizerConfig.presets.w8.md)                     | int8 weight-only quantization, per-channel symmetric.                          |
