...
For more details on how to use `KMeansPalettizerConfig`, `ModuleKMeansPalettizerConfig` to apply different settings to different weights in the model, see [Palettization Config](config.md).
