...
For more details on how to use [`MagnitudePrunerConfig`](../api/generated/coreai_opt.pruning.MagnitudePrunerConfig.md#coreai_opt.pruning.MagnitudePrunerConfig), [`ModuleMagnitudePrunerConfig`](../api/generated/coreai_opt.pruning.ModuleMagnitudePrunerConfig.md#coreai_opt.pruning.ModuleMagnitudePrunerConfig) to apply different settings to different weights in the model, see [Pruning Config](config.md).
